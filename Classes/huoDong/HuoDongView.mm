...
//  Fahuobao
//
//  Created by 智发 on 14-8-9.
//  Copyright (c) 2014年 西安智发网络科技有限公司. All rights reserved.
//

#import "HuoDongView.h"

@interface HuoDongView ()

@end

@implementation HuoDongView
...
- (void)viewDidLoad
{
   ...
   request = [[NSURLRequest alloc]initWithURL:[NSURL URLWithString:@"http://115.28.78.87:8080/kdb_server/huodong.html"]];
